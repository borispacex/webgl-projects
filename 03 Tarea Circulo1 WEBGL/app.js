...
var iniciarDemo = function() {
    ...
    // 1
    inicializaLosBuffers(gl, 0.0, 1.0, 1.0 , radio); // //light blue
    dibuja(gl, llenado);
    // 2
    inicializaLosBuffers(gl, 0.0, 0.0, 1.0, 0.2);   // BLUE
    dibuja(gl, false);
    // 3
    inicializaLosBuffers(gl, 1.0, 0.0, 0.0, 0.3);   // RED
    dibuja(gl, false);
    // 4
    inicializaLosBuffers(gl, 1.0, 1.0, 0.0, 0.4);   // amarillo
    dibuja(gl, false);
    // 5
    inicializaLosBuffers(gl, 0.0, 1.0, 0.0, 0.5);   // verde
    dibuja(gl, false);
    // 6
    inicializaLosBuffers(gl, 0.0, 1.0, 1.0, 0.6);   //light blue
    dibuja(gl, false);
};