...
var iniciarDemo = function() {
    ...
    // 1
    gl.uniform4f(translation, 0.0, 0.35, 0.0, 0.0); // para mover
    inicializaLosBuffers(gl, 0.0, 0.0, 1.0, radio);   // BLUE
    dibuja(gl, llenado);
    // 2
    gl.uniform4f(translation, 0.2, 0.0, 0.0, 0.0);
    inicializaLosBuffers(gl, 0.0, 1.0, 0.0, radio);   // GREEN
    dibuja(gl, llenado);
    // 3
    gl.uniform4f(translation, -0.2, 0.0, 0.0, 0.0);
    inicializaLosBuffers(gl, 1.0, 0.0, 0.0, radio);   // RED
    dibuja(gl, llenado);
};